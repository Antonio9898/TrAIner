...
import { bA as createInvalidVariablesError, bB as getEnv$1, bC as setOnSetGetEnv } from "./runtime_GlVtDbC7.mjs";
...
const schema = { "SUPABASE_URL": { "context": "server", "access": "secret", "optional": true, "type": "string" }, "SUPABASE_KEY": { "context": "server", "access": "secret", "optional": true, "type": "string" }, "OPENROUTER_API_KEY": { "context": "server", "access": "secret", "type": "string" }, "OPENROUTER_MODEL": { "context": "server", "access": "public", "type": "string" }, "OPENROUTER_HTTP_REFERER": { "context": "server", "access": "public", "optional": true, "type": "string" } };
const getEnv = (key) => {
  return getEnv$1(key);
};
...
let OPENROUTER_API_KEY = _internalGetSecret("OPENROUTER_API_KEY");
export {
  OPENROUTER_MODEL as O,
  SUPABASE_URL as S,
  OPENROUTER_API_KEY as a,
  SUPABASE_KEY as b
};
